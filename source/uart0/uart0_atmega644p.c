/******************************************************************************
* source/uart0/uart0_atmega644p.c                                             *
* ===============================                                             *
*                                                                             *
...
//**************************<File version>*************************************
#define SYSTEM_UART0_SUB_VERSION \
    "source/uart0/uart0_atmega644p.c 26.10.2015 V1.0.0"

#define SYSTEM_UART0_UBRR_MASK 0x0FFF

//**************************[system_uart0_init]******************************** 26.10.2015
void system_uart0_init() {
    #ifdef UART0_TX
    ...
    UCSR0C = _BV(USBS0) | _BV(UCSZ01) | _BV(UCSZ00);
        // Bit 6-7 (UMSEL0n)=   00 asynchronous operation
