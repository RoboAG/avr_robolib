...
//**************************<File version>*************************************
#define SYSTEM_DELAY_VERSION \
    "source/delay/delay.c 27.09.2015 V1.0.0"
...
//**************************[system_delay_print_compiled]********************** 27.09.2015
void system_delay_print_compiled(void (*out)(uint8_t)) {

    string_from_const(out, SYSTEM_DELAY_VERSION                        "\r\n");
