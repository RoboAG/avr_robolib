...
#ifndef _ROBOLIB_ADC_H_
#define _ROBOLIB_ADC_H_

//**************************<Macros>*******************************************
//! The number of bytes the adc modul uses in order to work
#define ROBOLIB_RAM_COUNT_ADC 8
 ...
 *
 * @sa robolib_adc_print_compiled()
 */
#ifndef __DOXYGEN__
    void robolib_adc_print(void (*out)(uint8_t));
#else
    void robolib_adc_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa robolib_adc_print()
 */
#ifndef __DOXYGEN__
    void robolib_adc_print_compiled(void (*out)(uint8_t));
#else
    void robolib_adc_print_compiled(void* out);
#endif
...
#ifndef __DOXYGEN__
    __inline__ void robolib_adc_init_inline(void) {
        #ifdef ROBOLIB_INIT
            ROBOLIB_INIT();
        #endif
