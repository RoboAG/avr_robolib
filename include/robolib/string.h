...
#ifndef _ROBOLIB_STRING_H_
#define _ROBOLIB_STRING_H_


//**************************<Macros>*******************************************
//! The number of bytes the string modul uses in order to work
#define ROBOLIB_RAM_COUNT_STRING 0
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa robolib_string_print_compiled()
 */
#ifndef __DOXYGEN__
    void robolib_string_print(void (*out)(uint8_t));
#else
    void robolib_string_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa robolib_string_print()
 */
#ifndef __DOXYGEN__
    void robolib_string_print_compiled(void (*out)(uint8_t));
#else
    void robolib_string_print_compiled(void* out);
#endif


// automated initializing
#ifndef __DOXYGEN__
    __inline__ void robolib_string_init_inline(void) {
        #ifdef ROBOLIB_INIT
            ROBOLIB_INIT();
        #endif
    }
