...
#ifndef _ROBOLIB_DISPLAY_BUFFERED_H_
#define _ROBOLIB_DISPLAY_BUFFERED_H_
...
#define ROBOLIB_RAM_COUNT_DISPLAY \
...
#else
    void robolib_display_buffer_print(void* out);
#endif
...
#else
    void robolib_display_buffer_print_compiled(void* out);
#endif
...
// automated initializing
#ifndef __DOXYGEN__
    __inline__ void robolib_display_buffer_init_inline(void) {
        #ifdef ROBOLIB_INIT
            ROBOLIB_INIT();
        #endif
    ...
    #undef ROBOLIB_INIT
    #define ROBOLIB_INIT()     robolib_display_buffer_init_inline()
    #define robolib_init()     cli(); ROBOLIB_INIT(); sei()
    #define robolib_init_cli() cli(); ROBOLIB_INIT()
#endif

#endif // #ifndef _ROBOLIB_DISPLAY_BUFFERED_H_
