...
#ifndef _ROBOLIB_DELAY_H_
#define _ROBOLIB_DELAY_H_


//**************************<Macros>*******************************************
//! The number of bytes the delay modul uses in order to work
#define ROBOLIB_RAM_COUNT_DELAY 0
 ...
 *
 * @sa robolib_delay_print_compiled()
 */
#ifndef __DOXYGEN__
    void robolib_delay_print(void (*out)(uint8_t));
#else
    void robolib_delay_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa robolib_delay_print()
 */
#ifndef __DOXYGEN__
    void robolib_delay_print_compiled(void (*out)(uint8_t));
#else
    void robolib_delay_print_compiled(void* out);
#endif


// automated initializing
#ifndef __DOXYGEN__
    __inline__ void robolib_delay_init_inline(void) {
        #ifdef ROBOLIB_INIT
            ROBOLIB_INIT();
        #endif
    }
