...
#ifndef _ROBOLIB_BOOTLOADER_H_
#define _ROBOLIB_BOOTLOADER_H_
...
#if (FLASHEND > 0xFFFF)
    #define ROBOLIB_RAM_COUNT_BOOTLOADER 4
#else //#if (FLASHEND > 0xFFFF)
    #define ROBOLIB_RAM_COUNT_BOOTLOADER 2
...
#else
    void robolib_bootloader_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa robolib_bootloader_print()
 */
#ifndef __DOXYGEN__
    void robolib_bootloader_print_compiled(void (*out)(uint8_t));
#else
    void robolib_bootloader_print_compiled(void* out);
#endif
...
#ifndef __DOXYGEN__
    __inline__ void robolib_bootloader_init_inline(void) {
        #ifdef ROBOLIB_INIT
            ROBOLIB_INIT();
        #endif

        robolib_bootloader_init();
    }

    #undef ROBOLIB_INIT
    #define ROBOLIB_INIT()     robolib_bootloader_init_inline()
    #define robolib_init()     cli(); ROBOLIB_INIT(); sei()
    #define robolib_init_cli() cli(); ROBOLIB_INIT()
#endif

#endif // #ifndef _ROBOLIB_BOOTLOADER_H_
