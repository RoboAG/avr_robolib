...
#ifndef _SYSTEM_UART1_H_
#define _SYSTEM_UART1_H_
...
#ifdef UART1_RX
    #ifdef UART1_TX
        #define SYSTEM_RAM_COUNT_UART1 UART1_RX + 2 + UART1_TX + 2
    #else //#ifdef UART1_TX
        #define SYSTEM_RAM_COUNT_UART1 UART1_RX + 2
    #endif //#ifdef UART1_TX
#else //#ifdef UART1_RX
    #ifdef UART1_TX
        #define SYSTEM_RAM_COUNT_UART1 UART1_TX + 2
    #else //#ifdef UART1_TX
        #define SYSTEM_RAM_COUNT_UART1 0
    #endif //#ifdef UART1_TX
#endif //#ifdef UART1_RX
 ...
 *
 * @sa system_uart1_print_compiled()
 */
#ifndef __DOXYGEN__
    void system_uart1_print(void (*out)(uint8_t));
#else
    void system_uart1_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa system_uart1_print()
 */
#ifndef __DOXYGEN__
    void system_uart1_print_compiled(void (*out)(uint8_t));
#else
    void system_uart1_print_compiled(void* out);
#endif
 ...
 */
void system_uart1_init(void);

// automated initializing
#ifndef __DOXYGEN__
    __inline__ void system_uart1_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
