...
#ifndef _SYSTEM_ADC_TIMER_H_
#define _SYSTEM_ADC_TIMER_H_

//**************************<Macros>*******************************************
//! The number of bytes the adc modul uses in order to work
#define SYSTEM_RAM_COUNT_ADC_TIMER 2

#ifndef __DOXYGEN__

    // warnings and errors
    #ifdef SYSTEM_SYSTICK
        #error "system/timer.h" has to be included after this file
    #endif //#ifndef SYSTEM_SYSTICK
 ...
 *
 * @sa system_adc_timer_print_compiled()
 */
#ifndef __DOXYGEN__
    void system_adc_timer_print(void (*out)(uint8_t));
#else
    void system_adc_timer_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa system_adc_timer_print()
 */
#ifndef __DOXYGEN__
    void system_adc_timer_print_compiled(void (*out)(uint8_t));
#else
    void system_adc_timer_print_compiled(void* out);
#endif
 ...
 */
void system_adc_timer_tick(void);

// automated systick implementation
#ifndef __DOXYGEN__
    __inline__ void system_adc_timer_tick_inline(void) {
        #ifdef SYSTEM_TICK_FUNCTION
            SYSTEM_TICK_FUNCTION();
        #endif;

        system_adc_timer_tick();
    }

    #define SYSTEM_TICK_FUNCTION() system_adc_timer_tick_inline()
#endif
 ...
 * Do not call this function at all.
 */
void system_adc_timer_init(void);

// automated initializing
#ifndef __DOXYGEN__
    __inline__ void system_adc_timer_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;

        system_adc_timer_init();
    }

    #define SYSTEM_INIT()     system_adc_timer_init_inline()
    #define system_init()     cli(); SYSTEM_INIT(); sei()
    #define system_init_cli() cli(); SYSTEM_INIT()
#endif

#endif // #ifndef _SYSTEM_ADC_TIMER_H_
