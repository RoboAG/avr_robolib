...
#ifndef _SYSTEM_BACKWARD_H_
#define _SYSTEM_BACKWARD_H_

//**************************<Macros>*******************************************
//! The number of bytes the types modul uses in order to work
#define SYSTEM_RAM_COUNT_BACKWARD 0
...
// system
  ...
  #define Init_System() system_init()
...
#ifndef __DOXYGEN__
    __inline__ void system_backward_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
    }

    #define SYSTEM_INIT()     system_backward_init_inline()
    #define system_init()     cli(); SYSTEM_INIT(); sei()
    #define system_init_cli() cli(); SYSTEM_INIT()
#endif

#endif // #ifndef _SYSTEM_BACKWARD_H_
