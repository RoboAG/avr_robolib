...
#ifndef _SYSTEM_UART0_H_
#define _SYSTEM_UART0_H_
...
#ifdef UART0_RX
    #ifdef UART0_TX
        #define SYSTEM_RAM_COUNT_UART0 UART0_RX + 2 + UART0_TX + 2
    #else //#ifdef UART0_TX
        #define SYSTEM_RAM_COUNT_UART0 UART0_RX + 2
    #endif //#ifdef UART0_TX
#else //#ifdef UART0_RX
    #ifdef UART0_TX
        #define SYSTEM_RAM_COUNT_UART0 UART0_TX + 2
    #else //#ifdef UART0_TX
        #define SYSTEM_RAM_COUNT_UART0 0
    #endif //#ifdef UART0_TX
#endif //#ifdef UART0_RX
 ...
 *
 * @sa system_uart0_print_compiled()
 */
#ifndef __DOXYGEN__
    void system_uart0_print(void (*out)(uint8_t));
#else
    void system_uart0_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa system_uart0_print()
 */
#ifndef __DOXYGEN__
    void system_uart0_print_compiled(void (*out)(uint8_t));
#else
    void system_uart0_print_compiled(void* out);
#endif
...
#ifndef __DOXYGEN__
    __inline__ void system_uart0_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
