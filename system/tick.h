...
#define SYSTEM_RAM_COUNT_TICK 0
 ...
 *
 * @sa system_tick_print_compiled()
 */
#ifndef __DOXYGEN__
    void system_tick_print(void (*out)(uint8_t));
#else
    void system_tick_print(void *out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa system_tick_print()
 */
#ifndef __DOXYGEN__
    void system_tick_print_compiled(void (*out)(uint8_t));
#else
    void system_tick_print_compiled(void *out);
#endif
...
#ifndef __DOXYGEN__
    __inline__ void system_tick_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
