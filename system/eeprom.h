...
#ifndef _SYSTEM_EEPROM_H_
#define _SYSTEM_EEPROM_H_
...
#define SYSTEM_RAM_COUNT_EEPROM 2
 ...
 *
 * @sa system_eeprom_print_compiled()
 */

#ifndef __DOXYGEN__
    void system_eeprom_print(void (*out)(uint8_t));
#else
    void system_eeprom_print(void* out);
#endif
 ...
 * Output function of type "void out(uint8_t)"
 *
 * @sa system_eeprom_print()
 */
#ifndef __DOXYGEN__
    void system_eeprom_print_compiled(void (*out)(uint8_t));
#else
    void system_eeprom_print_compiled(void* out);
#endif
...
#ifndef __DOXYGEN__
    __inline__ void system_eeprom_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
