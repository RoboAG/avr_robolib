...
#ifndef _SYSTEM_DISPLAY_H_
#define _SYSTEM_DISPLAY_H_
...
//**************************<Macros>*******************************************
    ...
    #define SYSTEM_DISPLAY_PORT SYSTEM_PORT_CREATE(DISPLAY_PORT)
    #define SYSTEM_DISPLAY_PIN  SYSTEM_PIN_CREATE( DISPLAY_PORT)
    #define SYSTEM_DISPLAY_DDR  SYSTEM_DDR_CREATE( DISPLAY_PORT)
    ...
    #define SYSTEM_DISPLAY_DATA_PORT SYSTEM_PORT_CREATE(DISPLAY_DATA_PORT)
    #define SYSTEM_DISPLAY_DATA_PIN  SYSTEM_PIN_CREATE( DISPLAY_DATA_PORT)
    #define SYSTEM_DISPLAY_DATA_DDR  SYSTEM_DDR_CREATE( DISPLAY_DATA_PORT)

    #ifdef DISPLAY_DATA_HI
        #define SYSTEM_DISPLAY_BUSY_GET()    (SYSTEM_DISPLAY_DATA_PIN &  0x80)
        #define SYSTEM_DISPLAY_DATA_DDR_R()  (SYSTEM_DISPLAY_DATA_DDR&= ~0xF0)
        #define SYSTEM_DISPLAY_DATA_DDR_W()  (SYSTEM_DISPLAY_DATA_DDR|=  0xF0)
        #define SYSTEM_DISPLAY_DATA_GET_L()  (SYSTEM_DISPLAY_DATA_PIN >>    4)
        #define SYSTEM_DISPLAY_DATA_GET_H()  (SYSTEM_DISPLAY_DATA_PIN &  0xF0)
        #define SYSTEM_DISPLAY_DATA_SET_L(x) (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0x0F) |(x <<   4))
        #define SYSTEM_DISPLAY_DATA_SET_H(x) (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0x0F) |(x & 0xF0))
        #define SYSTEM_DISPLAY_DATA_SET_0()  (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0x0F))
    #else // #ifdef DISPLAY_DATA_HI
        #define SYSTEM_DISPLAY_BUSY_GET()    (SYSTEM_DISPLAY_DATA_PIN &  0x08)
        #define SYSTEM_DISPLAY_DATA_DDR_R()  (SYSTEM_DISPLAY_DATA_DDR&= ~0x0F)
        #define SYSTEM_DISPLAY_DATA_DDR_W()  (SYSTEM_DISPLAY_DATA_DDR|=  0x0F)
        #define SYSTEM_DISPLAY_DATA_GET_L()  (SYSTEM_DISPLAY_DATA_PIN &  0x0F)
        #define SYSTEM_DISPLAY_DATA_GET_H()  (SYSTEM_DISPLAY_DATA_PIN <<    4)
        #define SYSTEM_DISPLAY_DATA_SET_L(x) (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0xF0) |(x & 0x0F))
        #define SYSTEM_DISPLAY_DATA_SET_H(x) (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0xF0) |(x >>   4))
        #define SYSTEM_DISPLAY_DATA_SET_0()  (SYSTEM_DISPLAY_DATA_PORT = \
          (SYSTEM_DISPLAY_DATA_PORT & 0xF0))
    #endif // #ifdef DISPLAY_DATA_HI

    #define SYSTEM_DISPLAY_PIN_SET_E(x)  (x ? (SYSTEM_DISPLAY_PORT|= \
      _BV(DISPLAY_PIN_E )): (SYSTEM_DISPLAY_PORT&= ~_BV(DISPLAY_PIN_E )))
    #define SYSTEM_DISPLAY_PIN_SET_RS(x) (x ? (SYSTEM_DISPLAY_PORT|= \
      _BV(DISPLAY_PIN_RS)): (SYSTEM_DISPLAY_PORT&= ~_BV(DISPLAY_PIN_RS)))
    #define SYSTEM_DISPLAY_PIN_SET_RW(x) (x ? (SYSTEM_DISPLAY_PORT|= \
      _BV(DISPLAY_PIN_RW)): (SYSTEM_DISPLAY_PORT&= ~_BV(DISPLAY_PIN_RW)))
...
#else
    void system_display_print(void* out);
#endif
...
#else
    void system_display_print_compiled(void* out);
#endif
...
// automated initializing
#ifndef __DOXYGEN__
    __inline__ void system_display_init_inline(void) {
        #ifdef SYSTEM_INIT
            SYSTEM_INIT();
        #endif;
    ...
    #define SYSTEM_INIT()     system_display_init_inline()
    #define system_init()     cli(); SYSTEM_INIT(); sei()
    #define system_init_cli() cli(); SYSTEM_INIT()
#endif

#endif // #ifndef _SYSTEM_DISPLAY_H_
